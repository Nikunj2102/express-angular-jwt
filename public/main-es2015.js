...
module.exports = "<div class=\"jumbotron text-center\">\n    <h1>MEAN Authentication App</h1>\n    <p class=\"lead\">Welcome to my MEAN authentication application</p>\n    <div>\n        <a class=\"btn btn-primary\" style=\"margin-right:2px;\" [routerLink]=\"['/register']\">Register</a> \n        <a class=\"btn btn-dark\" [routerLink]=\"['/login']\">Login</a>\n    </div>\n</div>\n    \n<div class=\"row\">\n    <div class=\"col-md-4\">\n        <h3>Express Backend</h3>\n        <p>A Express server using Mongoose to organize models and query the database</p>\n    </div>\n    <div class=\"col-md-4\">\n        <h3>Angular</h3>\n        <p>Angular to generate components, services and more.</p>\n    </div>\n    <div class=\"col-md-4\">\n        <h3>JWT</h3>\n        <p>Full featured authentication using JSON web tokens. Login and store user data</p>\n    </div>\n</div>\n\n      "
...
module.exports = "<nav class=\"navbar navbar-expand-md navbar-dark bg-dark\">\n  <a class=\"navbar-brand\" routerLink=\"/\">MEAN</a>\n    <ul class=\"navbar-nav mr-auto\">\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" routerLink=\"/\" routerLinkActive=\"active\">Home</a>\n      </li>\n    </ul>\n\n    <ul class=\"navbar-right navbar-nav\">\n      <li class=\"nav-item\" *ngIf=\"!authService.checkLogIn()\">\n        <a class=\"nav-link\" routerLink=\"/login\" routerLinkAcive=\"active\">Login</a>\n      </li>\n      <li class=\"nav-item\" *ngIf=\"authService.checkLogIn()\">\n        <a class=\"nav-link\" routerLink=\"/profile\" routerLinkAcive=\"active\">Profile</a>\n      </li>\n      <li class=\"nav-item\" *ngIf=\"authService.checkLogIn()\">\n        <a class=\"nav-link\" routerLink=\"/dashboard\" routerLinkAcive=\"active\">Dashboard</a>\n      </li>\n      <li class=\"nav-item\" *ngIf=\"!authService.checkLogIn()\">\n            <a class=\"nav-link\" routerLink=\"/register\" routerLinkActive=\"active\">Register</a>\n      </li>\n      <li class=\"nav-item\" *ngIf=\"authService.checkLogIn()\">\n        <a class=\"nav-link\" href='#' (click)=\"onLogoutClick()\">Logout</a>\n      </li>\n    </ul>\n</nav>\n"
...
const routes = [
    ...
    { path: 'dashboard', component: _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_5__["DashboardComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
    { path: 'profile', component: _profile_profile_component__WEBPACK_IMPORTED_MODULE_6__["ProfileComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
...
let RegisterComponent = class RegisterComponent {
    ...
    onRegisterSubmit() {
        ...
        if (!this.validateService.validateRegister(user)) {
            this.flashMessage.show('Please fill all the fields', { cssClass: 'alert-danger', timeout: 2500 });
            return false;
        }
        ...
        this.authService.registerUser(user).subscribe(data => {
            if (data.success) {
                this.flashMessage.show('User registered! You can now login', { cssClass: 'alert-success', timeout: 2000 });
                this.router.navigate(['/login']);
            }
            else {
...
let AuthService = class AuthService {
    ...
    getProfile() {
        this.loadToken();
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Authorization': this.authToken, 'Content-Type': 'application/json' });
